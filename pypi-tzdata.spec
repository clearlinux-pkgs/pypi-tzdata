...
Source0  : https://files.pythonhosted.org/packages/e1/34/943888654477a574a86a98e9896bae89c7aa15078ec29f490fef2f1e5384/tzdata-2024.2.tar.gz
...
%prep
%setup -q -n tzdata-2024.2
cd %{_builddir}/tzdata-2024.2
pushd ..
cp -a tzdata-2024.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727123407
