...
Source0  : https://files.pythonhosted.org/packages/1f/7a/ca39b0a6f86686816e675fb8bcd99f5f9ab413b1faff8578ab3f5a4bb9f9/tzdata-2022.4.tar.gz
...
%prep
%setup -q -n tzdata-2022.4
cd %{_builddir}/tzdata-2022.4
pushd ..
cp -a tzdata-2022.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664230595
