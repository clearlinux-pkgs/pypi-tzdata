...
Source0  : https://files.pythonhosted.org/packages/74/5b/e025d02cb3b66b7b76093404392d4b44343c69101cc85f4d180dd5784717/tzdata-2024.1.tar.gz
...
%prep
%setup -q -n tzdata-2024.1
cd %{_builddir}/tzdata-2024.1
pushd ..
cp -a tzdata-2024.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707758549
