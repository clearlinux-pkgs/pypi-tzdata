...
Source0  : https://files.pythonhosted.org/packages/95/32/1a225d6164441be760d75c2c42e2780dc0873fe382da3e98a2e1e48361e5/tzdata-2025.2.tar.gz
...
%prep
%setup -q -n tzdata-2025.2
cd %{_builddir}/tzdata-2025.2
pushd ..
cp -a tzdata-2025.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742761392
