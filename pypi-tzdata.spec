...
Source0  : https://files.pythonhosted.org/packages/5e/9f/63f7187ffd6d01dd5b5255b8c0b1c4f05ecfe79d940e0a243a6198071832/tzdata-2022.6.tar.gz
...
%prep
%setup -q -n tzdata-2022.6
cd %{_builddir}/tzdata-2022.6
pushd ..
cp -a tzdata-2022.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667193611
