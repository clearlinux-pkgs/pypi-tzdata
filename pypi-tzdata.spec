...
Source0  : https://files.pythonhosted.org/packages/95/91/5df9da4fd97126743d3c27442fbd0978cc2323b4ff512dee22a2ec83fbc2/tzdata-2022.5.tar.gz
...
%prep
%setup -q -n tzdata-2022.5
cd %{_builddir}/tzdata-2022.5
pushd ..
cp -a tzdata-2022.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665693443
